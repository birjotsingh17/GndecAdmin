...
public class AddIntra extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference(com.birjot.gndec_sports_admin.Activities.Constants.DATABASE_PATH_UPLOADS);
